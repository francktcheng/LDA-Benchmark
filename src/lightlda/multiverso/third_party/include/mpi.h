...
#define MPI_2COMPLEX          ((MPI_Datatype))
#define MPI_2DOUBLE_COMPLEX   ((MPI_Datatype))
#endif 
#define MPI_2REAL             ((MPI_Datatype)MPI_DATATYPE_NULL)
#define MPI_2DOUBLE_PRECISION ((MPI_Datatype)MPI_DATATYPE_NULL)
